SRC			=	main.c prompt.c get_directory.c get_username.c \
				...
				categorize_word.c cleaner.c syntax.c executor.c in_error.c \
				read_all.c get_args.c token.c pipe_exec.c next_operator.c is_operator.c \
				...
				change_pwd_var.c read_docs.c unlink_files.c my_pid.c set_sigpipe.c
